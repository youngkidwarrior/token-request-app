...
export const ETHER_TOKEN_FAKE_ADDRESS =
  '0x0000000000000000000000000000000000000000'; // support.
  ...
  [
    ...
    new Map([
      ...
      [
        ...
        { symbol: 'BAT', name: 'Bassic attention token', decimals: '18' },
      ],
    ]),
  ],
]);
...
export const evaluateNFTPrice = (
  ...
  if (blockTicker != 0) {
    timeDepreciation = maxValue * 0.01 * (blockTicker / blockInterval);
  }
